...
#LEFT JOIN T2 ON T1.id = T2.id: This performs a left join between T1 and T2 on the id column. 
#The left join ensures that all records from T1 are included, and matching records from T2 are also included if they exist.
